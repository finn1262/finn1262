# Hi there, I'm Dave Desabella <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="28px" height="28px"/>

**`finn1262`** · Developer from the Philippines 🇵🇭 (UTC+8)

I build **systems programs in C++** and **automation tools in Python**. From login systems and ordering platforms to crypto transaction trackers and trading bots — I like solving practical problems with clean, working code.
...
| [**BTC-5m-Polybot-Portable**](https://github.com/finn1262/BTC-5m-Polybot-Portable) | Portable 5-minute BTC trading bot with dashboard & TUI. |
...
A series of hands-on systems I've built to sharpen my fundamentals:
